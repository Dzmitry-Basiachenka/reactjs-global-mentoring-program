        ...
        <Container data-testid='movie-details'>
            <Row>
                ...
                <Col md={9}>
                    ...
                    {movie.genres && <div data-testid='movie-details-genres' className='d-flex mb-4'>{getGenres(movie.genres)}</div>}
                    <div className='d-flex'>
                        {movie.release_date && <span data-testid='movie-details-year' className='h5 text-danger'>{getYear(movie.release_date)}</span>}
                        {movie.runtime && <span data-testid='movie-details-runtime' className='h5 ms-4 text-danger'>{getRuntime(movie.runtime)}</span>}
                    </div>
